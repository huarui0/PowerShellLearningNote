...
import com.lzsoft.lzdata.mobile.purex.databinding.AndroidBasicSampleProductItemBinding;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ProductViewHolder> {
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        AndroidBasicSampleProductItemBinding binding;

        binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.android_basic_sample_product_item,
                        parent, false);
    ...
    static class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        final AndroidBasicSampleProductItemBinding binding;
...
*/
        ...
        public ProductViewHolder(AndroidBasicSampleProductItemBinding binding) {
            super(binding.getRoot());
            this.binding = binding;
        }
