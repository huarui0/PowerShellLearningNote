...
import com.lzsoft.lzdata.mobile.purex.databinding.AndroidBasicSampleCommentItemBinding;
...
/*
    ...
    public CommentViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        CommentItemBinding binding = DataBindingUtil
                .inflate(LayoutInflater.from(parent.getContext()), R.layout.android_basic_sample_comment_item,
                        parent, false);
...
*/
    @Override
    public CommentViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        AndroidBasicSampleCommentItemBinding binding = DataBindingUtil
                .inflate(LayoutInflater.from(parent.getContext()), R.layout.android_basic_sample_comment_item,
                        parent, false);
        binding.setCallback(mCommentClickCallback);
        return new CommentViewHolder(binding);
    ...
    static class CommentViewHolder extends RecyclerView.ViewHolder {
        ...
        final AndroidBasicSampleCommentItemBinding binding;
...
*/
        ...
        CommentViewHolder(AndroidBasicSampleCommentItemBinding binding) {
            super(binding.getRoot());
            this.binding = binding;
        }
