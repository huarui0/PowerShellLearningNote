...
import com.mpchart.charting.components.Legend.LegendForm;
...
import com.mpchart.charting.components.YAxis.YAxisLabelPosition;
...
import com.mpchart.charting.interfaces.datasets.IBarDataSet;
...
import com.mpchart.charting.model.GradientColor;
import com.mpchart.charting.utils.MPPointF;
import com.lzsoft.lzdata.mobile.purex.componentlib.chart.mpchart.mpchartexample.custom.DayAxisValueFormatter;
import com.lzsoft.lzdata.mobile.purex.componentlib.chart.mpchart.mpchartexample.custom.MyValueFormatter;
import com.lzsoft.lzdata.mobile.purex.componentlib.chart.mpchart.mpchartexample.custom.XYMarkerView;
...
public class BarChartActivity extends DemoBase implements OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mpchartexample_barchart);
    ...
    private void setData(int count, float range) {
        ...
        for (int i = (int) start; i < start + count; i++) {
            ...
            if (Math.random() * 100 < 25) {
                values.add(new BarEntry(i, val, getResources().getDrawable(R.drawable.star,null)));
            } else {
...
//            set1.setColors(ColorTemplate.MATERIAL_COLORS);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_mpchartexample_bar, menu);
        return true;
    }
