package com.lzsoft.lzdata.mobile.purex.componentlib.RecyclerView.thoughtbotrecyclerview;
...
public class ThouthtbotSampleActivity extends Activity {
  ...
  public OnClickListener navigateTo(final Class<?> clazz) {
    return new OnClickListener() {
      ...
      public void onClick(View v) {
        Intent intent = new Intent(ThouthtbotSampleActivity.this, clazz);
