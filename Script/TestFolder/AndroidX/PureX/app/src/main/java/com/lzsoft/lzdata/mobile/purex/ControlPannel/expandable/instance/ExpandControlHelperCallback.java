...
public class ExpandControlHelperCallback extends ItemTouchHelper.Callback {

    public static final float ALPHA_FULL = 1.0f;

    private final GenreComponentAdapter mAdapter;

    public ExpandControlHelperCallback(GenreComponentAdapter adapter) {
        mAdapter = adapter;
    }
