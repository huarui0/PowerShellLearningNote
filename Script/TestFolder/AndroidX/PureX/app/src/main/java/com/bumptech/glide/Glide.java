...
public class Glide implements ComponentCallbacks2 {
   ...
   * child fragment, the load should be started with {@link #with(androidx.fragment.app.Fragment)}} using that
   * child fragment. Similarly, if the resource will be used in a view in the parent fragment, the
   * load should be started with {@link #with(androidx.fragment.app.Fragment)} using the parent fragment. In
   ...
   * {@link androidx.fragment.app.Fragment}, or {@link Activity} that contains the View.
   *
   * <p>A {@link Fragment} or {@link androidx.fragment.app.Fragment} is assumed to contain a View if the View
   ...
   *
   * <p>When used in Applications that use the non-support {@link androidx.fragment.app.Fragment} classes,
   * calling this method will produce noisy logs from {@link androidx.fragment.app.FragmentManager}. Consider
   ...
   * discover support {@link Fragment}s. Any non-support {@link androidx.fragment.app.Fragment}s attached
