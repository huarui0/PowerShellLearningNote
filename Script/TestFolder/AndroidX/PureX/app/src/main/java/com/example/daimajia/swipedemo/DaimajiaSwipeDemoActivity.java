...
public class DaimajiaSwipeDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.daimajia_swipe_demo_main);
...
//        swipeLayout.setDragEdge(SwipeLayout.DragEdge.Bottom); // Set in XML
        ...
        sample1.getSurfaceView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(DaimajiaSwipeDemoActivity.this, "Click on surface", Toast.LENGTH_SHORT).show();
                Log.d(DaimajiaSwipeDemoActivity.class.getName(), "click on surface");
            }
        });
        sample1.getSurfaceView().setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(DaimajiaSwipeDemoActivity.this, "longClick on surface", Toast.LENGTH_SHORT).show();
                Log.d(DaimajiaSwipeDemoActivity.class.getName(), "longClick on surface");
                return true;
            }
        });
        sample1.findViewById(R.id.star2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(DaimajiaSwipeDemoActivity.this, "Star", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        sample1.findViewById(R.id.trash2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(DaimajiaSwipeDemoActivity.this, "Trash Bin", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        sample1.findViewById(R.id.magnifier2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(DaimajiaSwipeDemoActivity.this, "Magnifier", Toast.LENGTH_SHORT).show();
            }
        });
...
//        sample2.setShowMode(SwipeLayout.ShowMode.PullOut);
        ...
        sample2.findViewById(R.id.click).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(DaimajiaSwipeDemoActivity.this, "Yo", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_daimajia_swipe_demo, menu);
        return true;
    }
