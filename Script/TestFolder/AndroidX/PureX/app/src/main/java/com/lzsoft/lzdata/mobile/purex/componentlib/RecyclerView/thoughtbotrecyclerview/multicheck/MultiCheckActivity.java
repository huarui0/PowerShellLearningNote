...
import static com.lzsoft.lzdata.mobile.purex.componentlib.RecyclerView.thoughtbotrecyclerview.GenreDataFactory.makeMultiCheckGenres;
...
public class MultiCheckActivity extends AppCompatActivity {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_thoughtbot_recyclerview_multi_check);
