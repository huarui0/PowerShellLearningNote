...
import com.mpchart.charting.charts.CandleStickChart;
...
public class CandleStickChartActivity extends DemoBase implements OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mpchartexample_candlechart);
...
//        set1.setColor(Color.rgb(80, 80, 80));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_mpchartexample_candle, menu);
        return true;
    }
