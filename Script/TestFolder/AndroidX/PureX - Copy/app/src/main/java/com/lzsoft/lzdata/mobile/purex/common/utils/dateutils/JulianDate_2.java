package com.lzsoft.lzdata.mobile.purex.common.utils.dateutils;// https://github.com/jze/calendar/tree/1c9afbe43263dca43247b0746ad246f7bdedf6f8/src/main/java/de/zedlitz/calendar
 ...
 *
 */
public class JulianDate_2 extends AbstractDate {
    ...
    public JulianDate_2(double julianDay) {
        this.setJulianDay(julianDay);
    }

    public JulianDate_2(int year, int month, int day) {
        this.year = year;
        this.month = month;
        this.day = day;
    }
