package com.lzsoft.lzdata.mobile.purex.componentlib.RecyclerView.fullrecycleview.addfavorites;
...
import com.lzsoft.lzdata.mobile.purex.componentlib.RecyclerView.fullrecycleview.common.model.Fruit;
...
public class AddFavoritesAdapter extends RecyclerView
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fullrecyclerview_add_favorites_list_item, parent, false);

        View viewSection = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fullrecyclerview_add_favorites_section_list_item, parent, false);
