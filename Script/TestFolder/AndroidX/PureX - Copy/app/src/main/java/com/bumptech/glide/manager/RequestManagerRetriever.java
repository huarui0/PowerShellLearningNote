...
public class RequestManagerRetriever implements Handler.Callback {
  ...
  @VisibleForTesting
  final Map<androidx.fragment.app.FragmentManager, RequestManagerFragment> pendingRequestManagerFragments =
      new HashMap<>();
  ...
  private final ArrayMap<View, androidx.fragment.app.Fragment> tempViewToFragment = new ArrayMap<>();
  ...
  public RequestManager get(@NonNull FragmentActivity activity) {
    if (Util.isOnBackgroundThread()) {
      ...
      assertNotDestroyed((AppCompatActivity)activity);
      FragmentManager fm = activity.getSupportFragmentManager();
      return supportFragmentGet(
          activity, fm, /*parentHint=*/ null, isActivityVisible((AppCompatActivity)activity));
    }
  }
  ...
  @SuppressWarnings("deprecation")
  @NonNull
  public RequestManager get(@NonNull AppCompatActivity activity) {
    if (Util.isOnBackgroundThread()) {
      return get(activity.getApplicationContext());
    } else {
  ...
  public RequestManager get(@NonNull View view) {
    ...
    AppCompatActivity activity = (AppCompatActivity)findActivity(view.getContext());
    ...
    // Standard Fragments.
    androidx.fragment.app.Fragment fragment = findFragment(view, activity);
    if (fragment == null) {
      return get(activity);
    }
    return get(fragment);
  ...
  @Deprecated
  @Nullable
  private androidx.fragment.app.Fragment findFragment(@NonNull View target, @NonNull AppCompatActivity activity) {
    tempViewToFragment.clear();
    findAllFragmentsWithViews(activity.getSupportFragmentManager(), tempViewToFragment);
  ...
  private void findAllFragmentsWithViews(
      ...
      @NonNull ArrayMap<View, androidx.fragment.app.Fragment> result) {
  ...
  private static void assertNotDestroyed(@NonNull AppCompatActivity  activity) {
  ...
  @Deprecated
  @NonNull
  RequestManagerFragment getRequestManagerFragment(AppCompatActivity activity) {
  ...
  private RequestManagerFragment getRequestManagerFragment(
      ...
      @Nullable androidx.fragment.app.Fragment parentHint,
  ...
  SupportRequestManagerFragment getSupportRequestManagerFragment(FragmentActivity activity) {
    return getSupportRequestManagerFragment(
        activity.getSupportFragmentManager(), /*parentHint=*/ null, isActivityVisible((AppCompatActivity )activity));
  }

  private static boolean isActivityVisible(AppCompatActivity activity) {
  ...
  public boolean handleMessage(Message message) {
    ...
    switch (message.what) {
      case ID_REMOVE_FRAGMENT_MANAGER:
        androidx.fragment.app.FragmentManager fm = (androidx.fragment.app.FragmentManager) message.obj;
        key = fm;
