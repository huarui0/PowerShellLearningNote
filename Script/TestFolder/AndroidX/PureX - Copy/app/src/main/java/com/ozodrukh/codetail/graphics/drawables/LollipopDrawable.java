package com.ozodrukh.codetail.graphics.drawables;
 ...
 */
public abstract class LollipopDrawable extends RippleDrawable {
     ...
     */
    public LollipopDrawable(@NonNull ColorStateList color, @Nullable Drawable content, @Nullable Drawable mask) {
