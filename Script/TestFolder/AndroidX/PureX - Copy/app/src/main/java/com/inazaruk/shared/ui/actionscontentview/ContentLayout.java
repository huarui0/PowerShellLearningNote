package com.inazaruk.shared.ui.actionscontentview; /*******************************************************************************
...
class ContentLayout extends LinearLayout {
  ...
  protected void dispatchDraw(Canvas canvas) {
    ...
    if (fadeFactor > 0f) {
      // mFadePaint.setColor(Color.argb(fadeFactor, 0, 0, 0)); orginal setting wanglai 2018-11-27
      mFadePaint.setColor(Color.argb(fadeFactor, 218, 225, 237));
