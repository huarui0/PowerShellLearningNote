package com.lzsoft.lzdata.mobile.purex.componentlib.RecyclerView.fullrecycleview.sectionwithline;
...
public class SectionWithLineAdapter extends RecyclerView
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fullrecyclerview_section_with_line_list_item, parent, false);

        View viewSection = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fullrecyclerview_section_with_lien_list_item_header, parent, false);
