...
// import com.lzsoft.lzdata.mobile.purex.databinding.ListFragmentBinding;
import com.lzsoft.lzdata.mobile.purex.databinding.AndroidBasicSampleListFragmentBinding;
...
public class ProductListFragment extends Fragment {
    ...
    private AndroidBasicSampleListFragmentBinding mBinding;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
            @Nullable Bundle savedInstanceState) {
        mBinding = DataBindingUtil.inflate(inflater, R.layout.android_basic_sample_list_fragment, container, false);
    ...
    private final ProductClickCallback mProductClickCallback = new ProductClickCallback() {
        ...
        public void onClick(Product product) {
            ...
            if (getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED)) {
                ((BasicSamplePersistenceActivity) getActivity()).show(product);
            }
        }
    };
}
