...
public class BasicSamplePersistenceActivityTest {

    @Rule
    public ActivityTestRule<BasicSamplePersistenceActivity> mActivityRule = new ActivityTestRule<>(
            BasicSamplePersistenceActivity.class);

    @Rule
    public CountingTaskExecutorRule mCountingTaskExecutorRule = new CountingTaskExecutorRule();

    public BasicSamplePersistenceActivityTest() {
        // delete the database
