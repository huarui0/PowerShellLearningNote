...
package com.example.android.persistencecontentprovider;
...
import com.example.android.persistencecontentprovider.data.Cheese;
import com.example.android.persistencecontentprovider.provider.SampleContentProvider;
 ...
 */
public class PersistenceContentProviderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_persistence_content_provider_sample);
    ...
    private static class CheeseAdapter extends RecyclerView.Adapter<CheeseAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            if (mCursor.moveToPosition(position)) {
                // RecyclerView的List字体颜色在此更改！
                holder.mText.setTextColor(Color.LTGRAY);
