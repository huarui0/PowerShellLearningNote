...
import com.lzsoft.lzdata.mobile.purex.componentlib.chart.mpchart.mpchartexample.custom.CustomScatterShapeRenderer;
...
public class ScatterChartActivity extends DemoBase implements OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mpchartexample_scatterchart);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_mpchartexample_scatter, menu);
        return true;
    }
