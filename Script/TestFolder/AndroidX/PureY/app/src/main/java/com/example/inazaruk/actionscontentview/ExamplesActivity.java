...
import com.example.inazaruk.actionscontentview.adapter.ActionsAdapter;
import com.example.inazaruk.actionscontentview.fragment.AboutFragment;
import com.example.inazaruk.actionscontentview.fragment.SandboxFragment;
import com.example.inazaruk.actionscontentview.fragment.WebViewFragment;
...
public class ExamplesActivity extends FragmentActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.inazaruk_actionscontentview_example);

    viewActionsContentView = findViewById(R.id.actionsContentView);
    viewActionsContentView.setSwipingType(ActionsContentView.SWIPING_EDGE);

    // viewActionsContentView.setBackgroundColor(Color.TRANSPARENT);

    final ListView viewActionsList = findViewById(R.id.actions);

    viewActionsList.setBackgroundColor(Color.RED);
