...
public class Activity_Main_IO2014 extends AppCompatActivity {
    public static SparseArray<Bitmap> sPhotoCache = new SparseArray<Bitmap>(4);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_android_io_2014_main);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_android_io_2014_main, menu);
        return true;
    }
    ...
    public void showPhoto(View view) {
        ...
        intent.setClass(this, Activity_Detail_IO2014.class);
        ...
        switch (view.getId()) {
            case R.id.show_photo_1:
                ...
                intent.putExtra("photo", R.drawable.album1);
                break;
            case R.id.show_photo_2:
                ...
                intent.putExtra("description", getResources().getText(R.string.lorem));
                intent.putExtra("photo", R.drawable.album2);
                break;
            case R.id.show_photo_3:
                ...
                intent.putExtra("description", getResources().getText(R.string.lorem));
                intent.putExtra("photo", R.drawable.album3);
                break;
            case R.id.show_photo_4:
                ...
                intent.putExtra("description", getResources().getText(R.string.lorem));
                intent.putExtra("photo", R.drawable.album4);
                break;
        }

        ImageView hero =  ((View) view.getParent()).findViewById(R.id.photo);
