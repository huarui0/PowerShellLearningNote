...
*/
  ...
  public static List<ComponentSample> makeSQLiteComponentSamples() {
    ComponentSample androidSQLiteRoomDemoPesistence = new ComponentSample("SQLite Room Sample","SQLite Room Demo", "com.example.android.persistence",true);

    return Arrays.asList(androidSQLiteRoomDemoPesistence);
  }
...
*/
  ...
  public static List<ComponentSample> makeArchitectureComponentSamples() {
    ComponentSample androidBasicSamplePesistence = new ComponentSample("Basic Sample Pesistence","SQLite Room(Architecture Component) Demo", "com.example.android.persistence",true);
    ComponentSample androidPersistenceContentProviderSample = new ComponentSample("Persistence ContentProvider Sample","Persistence ContentProvider(Architecture Component) Demo", "com.example.android.persistencecontentprovider",true);
    ...
    ComponentSample androidRxJavaKotlinDemo = new ComponentSample("Basic RxJava Kotlin Sample","Basic RxJava Kotlin(Architecture Component) Demo", "com.example.android_kotlin.observability",true);
    ComponentSample androidLiveDataKotlinDemo = new ComponentSample("LiveData Kotlin Sample","LiveData Kotlin(Architecture Component) Demo", "com.example.android_kotlin.livedatabuilder",true);

    return Arrays.asList(androidBasicSamplePesistence, androidPersistenceContentProviderSample, androidRxJavaDemo, androidRxJavaKotlinDemo, androidLiveDataKotlinDemo);
  }
