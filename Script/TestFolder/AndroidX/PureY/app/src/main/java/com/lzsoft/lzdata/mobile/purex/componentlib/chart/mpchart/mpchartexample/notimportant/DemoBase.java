...
public abstract class DemoBase extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tfRegular = Typeface.createFromAsset(getAssets(), "fonts/opensans-regular.ttf");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        overridePendingTransition(R.anim.anim_move_left_in_activity, R.anim.anim_move_right_out_activity);
    }
