...
public class MaterialRippleDemoRecyclerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_balysv_material_ripple_recycler);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_balysv_material_ripple_recycler, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.switch_button) {
            ...
            startActivity(new Intent(this, MaterialRippleDemoListActivity.class));
            finish();
            return true;
        }
    ...
    private static class MyAdapter extends RecyclerView.Adapter<MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            return new MyViewHolder(
                MaterialRippleLayout.on(inflater.inflate(R.layout.activity_demo_balysv_material_ripple_recycler_item, viewGroup, false))
                    .rippleOverlay(true)
                    .rippleAlpha(0.2f)
