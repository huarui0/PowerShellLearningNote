...
import com.mpchart.charting.charts.BubbleChart;
...
import com.mpchart.charting.interfaces.datasets.IBubbleDataSet;
...
public class BubbleChartActivity extends DemoBase implements OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mpchartexample_bubblechart);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_mpchartexample_bubble, menu);
        return true;
    }
