...
class MyAdapter extends ArrayAdapter<ContentItem> {
    ...
    MyAdapter(Context context, List<ContentItem> objects) {
        ...
        mTypeFaceLight = Typeface.createFromAsset(context.getAssets(), "fonts/opensans-light.ttf");
        mTypeFaceRegular = Typeface.createFromAsset(context.getAssets(), "fonts/opensans-regular.ttf");
    }
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (c != null && c.isSection) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.mpchartexample_list_item_section, null);
        } else {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.mpchartexample_list_item, null);
        }
