...
package com.lzsoft.lzdata.mobile.purex.common.utils.dateutils;
...
public class JulianDate extends Julian_Date {
    ...
    public static void main(String args[]) {
        ...
        double julian = (Math.floor(365.25 * year_toJD)
                + Math.floor(30.6001 * month_toJD) + day_toJD + 1720995.0);
