...
public class PopActivity extends Activity implements OnClickListener {
    private String TAG = PopActivity.class.getName();
    ...
    private void setLinstener() {
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                mPopTop.showAtLocation(view, Gravity.NO_GRAVITY, ScreenUtils.getScreenWidth(thisContext) / 4, location[1]);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_state:
                //	 setMyPop();
                mPopTop.showAtLocation(rel_titlebar, Gravity.TOP, 0, height + ScreenUtils.getStatusHeight(thisContext)); //titleBar 正下方中间位置
