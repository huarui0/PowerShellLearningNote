...
import com.huarui.mobile.sunshine.ForecastFragment.OnRefreshItemListener;

/**
 * Created by wanglai on 11/28/2016.
 */

public class MainSunshineActivity extends Activity implements OnRefreshItemListener {
    ...
    private final String LOG_TAG = MainSunshineActivity.class.getSimpleName();
        ...
        switch (id) {
            ...
            case MENU_ITEM_2:
                ...
                */
                ...
                displayToast("MENU_ITEM_2 Selected! Code:" + id + "，Name：" + MainSunshineActivity.class.getSimpleName() + ".");
                return true; // break;
            case MENU_ITEM_3:
                /*
                Intent intent = new Intent(this, PopActivity.class);
    ...
    @Override
    public void OnRefreshItemListener(ForecastFragment.FetchWeatherTask weatherTask) {
